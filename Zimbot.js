...
//▮WhatsApp¹ : http://wa.me/+212777466518  
//▮WhatsApp² : http://wa.me/+212704349329
//▮
//╰▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀
//
//┏━━━━━━━━━━━━━━━━━━━━━━━━━
...
//┃
//┃THANKS FOR CHOOSING bot 𝐀𝐋𝐕𝐀𝐑𝐎⃢🌹ٱࢦأمࢪيــڪي
...
case 'bc2': case 'bcloc': {
if (!isCreator) throw mess.owner
if (!text) throw `*Type some text*\n\nExample : ${prefix + command} alvaro|hi5`
let anu = await store.chats.all().map(v => v.id)
